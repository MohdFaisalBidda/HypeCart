...
const ProductItem = ({ src, desc, id}) => {
  return (
    ...
    transition={{ duration: 1 }}
      ...
      <h1 className='mt-2 text-sm border border-black w-28 h-6 text-black font-bold hover:bg-black hover:text-white cursor-pointer rounded-full mx-auto' onClick={()=>console.log(id)}>Show More</h1>
