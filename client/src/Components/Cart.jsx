            ...
            <div className="flex md:justify-between md:flex-row flex-col md:my-0 my-10">
                <div className="md:flex-[3] ">
                    <div className="flex justify-between md:flex-row flex-col px-10 ">
                        <img src="https://cdn.lorem.space/images/shoes/.cache/640x480/alex-motoc-xyjB6_ZDaKw-unsplash.jpg" className='w-[200px] object-contain mx-auto' alt="Hello" />
                        <div className="md:flex-[2] md:text-start text-center flex flex-col justify-around md:p-20 text-lg">
                            <h3 className='py-1'><b>Product Desc</b>: Product</h3>
                            <h3 className='py-1'><b>Id</b>: Product</h3>
                            <h3 className='py-1'><b>Color</b>: Product</h3>
                            <h3 className='py-1'><b>Size</b>: Product</h3>
                    ...
                    <div className="flex justify-between md:flex-row flex-col p-10">
                        <img src="https://cdn.lorem.space/images/shoes/.cache/640x480/alex-motoc-xyjB6_ZDaKw-unsplash.jpg" className='w-[200px] object-contain mx-auto' alt="Hello" />
                        <div className="md:flex-[2] md:text-start text-center flex flex-col md:justify-around md:p-20 text-lg">
                            <h3 className='py-1'><b>Product Desc</b>: Product</h3>
                            <h3 className='py-1'><b>Id</b>: Product</h3>
                            <h3 className='py-1'><b>Color</b>: Product</h3>
                            <h3 className='py-1'><b>Size</b>: Product</h3>
                ...
                <div className="md:flex-[1] h-[32rem] rounded-lg border border-black p-10 mx-10">
