...
const ProductItem = ({ src, desc, id }) => {
  return (
    <motion.div
      ...
      <h1 className='mt-2 mb-2 text-xl'>{desc}</h1>
      <Link to={`/product/${id}`} className='px-4 py-1 text-sm border border-black w-28 h-6 text-black font-bold hover:bg-black hover:text-white cursor-pointer rounded-full mx-auto'>Show More</Link>
