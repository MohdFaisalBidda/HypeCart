  ...
  return (
    <motion.div
     ...
     key={id}
      ...
      <Link to={`/category/${category}`} className='bg-black text-white hover:bg-transparent hover:border-2 border-black hover:text-black hover:font-bold py-2 cursor-pointer font-medium font-serif rounded-xl'>Show Products</Link>
